...
<div class="section">
    ...
    <img width="48px" height="48px" src="${baseUrl}/download/resources/${groupId}.${artifactId}/artifactory-icon.png"/>
...
<div class="section">
    ...
    [#if promoting]
        [@ww.form action='promote' submitLabelKey='Update' titleKey='Promote' showActionErrors=false]
