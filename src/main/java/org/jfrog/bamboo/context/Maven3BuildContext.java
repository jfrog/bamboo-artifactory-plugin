...
public class Maven3BuildContext extends AbstractBuildContext {
    ...
    public static Set<String> getFieldsToCopy() {
        Set<String> fieldsToCopy = Sets.newHashSet(PREFIX + SERVER_ID_PARAM, PREFIX + RESOLUTION_REPO_PARAM,
                ...
                PREFIX + DEPLOYER_PASSWORD_PARAM, PREFIX + PUBLISH_BUILD_INFO_PARAM, PREFIX + INCLUDE_ENV_VARS_PARAM,
                ...
                PREFIX + EXCLUDE_PATTERN, PREFIX + GOALS, PREFIX + ADDITIONAL_MAVEN_PARAMS, PREFIX + JDK,
